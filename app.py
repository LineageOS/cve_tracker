...
@app.route("/api/v1/kernels/<k>/cve/<c>", methods=['POST'])
@require_login
def update(k, c):
    r = request.get_json()
    s = r['status_id'];
...
@app.route("/api/v1/cves", methods=['POST'])
@require_login
def addcve():
...
@app.route("/api/v1/kernels", methods=['POST'])
@require_login
def addkernel():
    errstatus = "Generic error"
    r = request.get_json()
...
@app.route("/api/v1/links/<linkid>", methods=['DELETE'])
@require_login
...
@app.route("/api/v1/cves/<cve>/notes", methods=['POST'])
@require_login
def editnotes(cve):
    errstatus = "Generic error"
    r = request.get_json()
...
@app.route("/api/v1/links/<linkid>", methods=['POST'])
@require_login
def editlink():
    errstatus = "Generic error"
    r = request.get_json()
...
@app.route("/api/v1/cves/<cve>/links", methods=['GET'])
def getlinks(cve):
...
@app.route("/api/v1/cves/<cve>/notes", methods=['GET'])
def getnotes(cve):
...
@app.route("/api/v1/kernels/<k>/deprecate", methods=['POST'])
@require_login
def deprecate(k):
    r = request.get_json()
    d = r['deprecate']
