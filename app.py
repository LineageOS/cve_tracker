...
def show_last_update():
    print(str('SHOW_LAST_UPDATE' in app.config))
    return ('SHOW_LAST_UPDATE' in app.config and
        app.config['SHOW_LAST_UPDATE'] == True)
...
def kernel(k):
    ...
    return render_template('kernel.html',
                           ...
                           getVendorNameFromRepo=utils.getVendorNameFromRepo)
