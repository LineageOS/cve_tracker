...
def error(msg = ""):
    return render_template('error.html', msg=msg, needs_auth=needs_auth(), authorized=logged_in())
...
def addcve():
    ...
    cve = r['cve_id']
    notes = r['cve_notes']
    # Match CVE-1990-0000 to CVE-2999-NNNNNNN (CVE or LVT) to ensure at least a little sanity
...
def addlink():
    ...
    elif not l or not urllib.parse.urlparse(l):
