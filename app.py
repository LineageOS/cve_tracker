...
def logged_in():
    return (('github_token' in session and session['github_token']) or
        needs_auth())
...
def show_kernels(deprecated):
    ...
    for kernel in kernels:
        ...
        # remember and count already counted headers
        ...
        # check if rowlimit was reached and go to next row
    ...
    return render_template(template, rows=orderedRows, version=version, authorized=logged_in(),
